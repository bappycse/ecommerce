                    ...
                    <tbody>
                        ...
                        @foreach ($products as $product)
                            <tr>
                                ...
                                <td><a href="/products/{{ $product->getId() }}/edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                  <form method ="POST" action="/products/{{ $product->getId() }}" style="display:inline-block">
